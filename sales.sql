...
SELECT product,
COUNT(product) as product_amount, 
AVG(price) as avg_price, 
price * count(product) as revenue
...
SELECT payment_type, count(product) as products_bought
FROM sales
